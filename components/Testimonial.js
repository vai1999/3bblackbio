...
const Testimonial = (props) => {
  ...
  return (
    <div className="text-center m-auto">
      ...
      <h1 className="text-2xl font-bold text-blue-500">Our Testimonials</h1>
        ...
        {testimonialData.map((el, i) => {
          return (
            ...
            >
              ...
              <div className="pt-3 pb-4 text-xl font-bold">{el.author}</div>
              <div className="text-sm font-bold">{el.head}</div>
            </div>
          );
        })}
        <div
